  ...
  return (
    <section id="contact" className="section-x py-24 border-t border-border">
      <Reveal>
        ...
        <p className="font-body text-xs md:text-sm lg:text-base text-body max-w-lg mb-10 leading-relaxed">
      ...
      <Reveal delay={0.15} className="flex flex-col sm:flex-row gap-4">
        <a
          ...
          className="text-xs md:text-sm lg:text-base flex items-center justify-center gap-2 bg-accent text-background font-body font-semibold px-8 py-2 rounded-full hover:bg-accent/70 transition-colors duration-200"
        >
        ...
        <a
          ...
          className="text-xs md:text-sm lg:text-base flex items-center justify-center gap-2 border border-border text-heading font-body font-semibold px-8 py-4 rounded-full hover:border-accent transition-colors duration-200"
        >
